...
object extractorPatterns {
  /** We need an abstract base class for trees.
    ...
    *
    * Here, we replaced case class of patterns.scala with objects
  ...
  /**
    ...
    * to create objects withouth the "new" keyword. It saves some typeing
    ...
    * were a function value. This trick works whth anyvalue that has
    * an apply method.
   */
  ...
  /**
    ...
    * "match" is a generalizatio of "switch" is C-like languages
    *
    * Patterns consist of cas class constructors (which can
    * be nested), and lower case variables which the class has been constructed.
    *
    * For extractors, it is not the name of a case class, but the name of
    * the sigleton object Branch which is use to refer to its extractor method
